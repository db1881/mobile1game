...
- Dahili test kanalı: etkin, sürüm `0.1.3-internal-4` (version code `4`)
...
23 Temmuz 2026'da toplam yıldız liderliği ile bağlı kümeleri gezen lazer/patlama güncellemesini
birleştiren imzalı Play App Bundle başarıyla üretildi: `Build/BalloonPop.aab` (51.005.105 bayt,
SHA-256 `149B2573C7114F6264E5E6C62EF7EE9E38AA9A865A742608728C26F59B1EFBBE`). Play Console
paketi kabul etti ve `0.1.3-internal-4` (version code `4`) sürümü Dahili test kanalında yayınlandı.
