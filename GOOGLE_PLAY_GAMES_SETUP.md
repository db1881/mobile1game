...
- Dahili test kanalı: etkin, sürüm `0.1.1-internal-2` (version code `2`)
...
22 Temmuz 2026'da güncel birleşik proje için imzalı Play App Bundle başarıyla üretildi:
`Build/BalloonPop.aab` (47.981.893 bayt). Play Console paketi kabul etti ve
`0.1.1-internal-2` (version code `2`) sürümü Dahili test kanalında yayınlandı.
...
- **Liderlik** düğmesi `Highest Score` verilerini oyun içindeki Candy UI panelinde gösterir.
